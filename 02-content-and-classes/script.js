...
const learning = document.getElementById("bio")
learning.innerHTML =" I am <strong>learning</strong> the DOM";
...
const current = Number(card.dataset.visits)  // 

card.dataset.visits = current + 1      
